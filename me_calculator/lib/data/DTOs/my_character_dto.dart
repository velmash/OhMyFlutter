...
import 'package:me_calculator/data/datasources/boss_data.dart';
...
extension MyCharacterMapper on MyCharacterDTO {
  MyCharacter toMyCharacter() => MyCharacter(
    nickName: nickName,
    imagePath: imagePath,
    ocid: ocid,
    bosses: bosses.map((serverId) => weeklyBossFromServerId(serverId)).toList(),
  );
}
